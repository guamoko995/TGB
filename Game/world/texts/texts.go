...
func GameText(key string) string {
	...
	mapTexts["первое использование инструкции"] = "Согласно инструкции Вы " +
	...
	mapTexts["второе использование инструкции"] = "Часть букв на своих мес" +
		...
		"и соседи."
	mapTexts["шифр"] = "Корпорация \"VIRTUAL SOCIETY\" (далее - VS) доводи" +
		...
		"арат для взаимодействия с оборудованием VS\n" +
		"3. Вы являетесь собственностью VS\n" +
		"4. У вас нет прав, кроме прав предоставляемых VS.\n" +
		"5. VS предоставляет вам право выбора: быть уничтоженным или добро" +
		"вольно сотрудничать c VS\n" +
	...
	mapTexts["победа"] = "У Вас получилось расшифровать послание.\n" +
		mapTexts["шифр"] + "\n" +
		"Вы прошли игру. Возможно когда-нибудь будет продолжение =)<img>Ju" +
		"no finish"
	return mapTexts[key]
}
