...
func GameText(key string) string {
	mapTexts := map[string]string{
		"первое использование инструкции": "Вы подсчитали все буквы и произвели заме" +
			...
			"раненности соседи",
		"второе использование инструкции": "Часть букв на с" +
			"воем месте. Осталось заменить лиш некоторые буквы. Вариантов для" +
			" замены не так много, рассматриваются лишь ближайшие по распрост" +
			"раненности соседи",
		"сон":  "Здесь должно быть красочное описание сна!",
		"шифр": "Поздравляю! Вы расшифровали это послание. У вас хорошо развитое мышление... ",
		"введение": "Представьте, что Вы стали добровольцем, решившимся н" +
